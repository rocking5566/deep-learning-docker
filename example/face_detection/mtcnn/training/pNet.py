...
with open(r'../data/12_cls.lmdb', 'rb') as fid:
    cls = pickle.load(fid)
with open(r'../data/12_roi.lmdb', 'rb') as fid:
    roi = pickle.load(fid)
...
img_input = Input(shape=[12, 12, 3])  # change this shape to [None,None,3] to enable arbitraty shape input
...
for i_train in range(80):
    ...
    if i_train == 0:
        ...
        # Load previous model to keep training
