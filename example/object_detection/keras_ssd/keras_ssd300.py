...
def ssd_300(image_size,
    ...
    Arguments:
        ...
        base_network: base network of ssd300.
            SSD_VGG16: This is a modified version of the VGG-16 model from keras.applications.vgg16.
                In particular, the fc6 and fc7 layers were convolutionalized and sub-sampled from depth 4096 to 1024
    ...
    if base_network == 'SSD_VGG16':
        from network.ssd_vgg16 import SSD_VGG16
        base_model = SSD_VGG16(input_tensor=x1, l2_reg=l2_reg)
        conv4_3 = base_model.get_layer(name='conv4_3').output
    ...
    #else:
    #    raise ValueError("No such base network.")
    fc7 = base_model.output
